...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var norm = function (_p0) {    var _p1 = _p0;var _p3 = _p1._1;var _p2 = _p1._0;return $Basics.sqrt(_p2 * _p2 + _p3 * _p3);};
   var minus = F2(function (_p5,_p4) {    var _p6 = _p5;var _p7 = _p4;return {ctor: "_Tuple2",_0: _p6._0 - _p7._0,_1: _p6._1 - _p7._1};});
   var plus = F2(function (_p9,_p8) {    var _p10 = _p9;var _p11 = _p8;return {ctor: "_Tuple2",_0: _p10._0 + _p11._0,_1: _p10._1 + _p11._1};});
   var rotate = F2(function (rads,_p12) {
      var _p13 = _p12;
      var _p15 = _p13._1;
      var _p14 = _p13._0;
      return {ctor: "_Tuple2",_0: $Basics.cos(rads) * _p14 - $Basics.sin(rads) * _p15,_1: $Basics.sin(rads) * _p14 + $Basics.cos(rads) * _p15};
   });
   var move = F2(function (_p17,_p16) {    var _p18 = _p17;var _p19 = _p16;return {ctor: "_Tuple2",_0: _p19._0 + _p18._0,_1: _p19._1 + _p18._1};});
   var scale = F2(function (s,_p20) {    var _p21 = _p20;return {ctor: "_Tuple2",_0: s * _p21._0,_1: s * _p21._1};});
   var normalize = function (pt) {    return A2(scale,1.0 / norm(pt),pt);};
   var normal = function (_p22) {    var _p23 = _p22;return normalize({ctor: "_Tuple2",_0: 0 - _p23._1,_1: _p23._0});};
   var scalePts = F2(function (s,pts) {    return A2($List.map,scale(s),pts);});
   var square = _U.list([{ctor: "_Tuple2",_0: -1,_1: 1},{ctor: "_Tuple2",_0: 1,_1: 1},{ctor: "_Tuple2",_0: 1,_1: -1},{ctor: "_Tuple2",_0: -1,_1: -1}]);
   var crazyQuad = A2(scalePts,30,square);
   var crazyPoly = $Graphics$Collage.polygon(crazyQuad);
   var main = A3($Graphics$Collage.collage,300,300,_U.list([A2($Graphics$Collage.outlined,$Graphics$Collage.defaultLine,crazyPoly)]));
